...
df1 = dr5.get_price_sum_in_n(price_up_sum=15, period_of_days=20)
df1 = dr5.get_price_sum_in_n(df1, is_price_up=False, price_up_sum=-10, period_of_days=10)
#df1 = myapi.read_csv("up-20-down-10-in-20days.csv")
df1 = dr5.get_ma5_across_ma10(df1, cross_above=False, period_of_days=4)
df1 = dr5.get_price_above(df1, type="close above ma20", period_of_days=1)
#df1 = dr5.get_price_up_with_percentage(df1, period_of_days=4)
df1 = dr5.get_price_above(df1, type="low below ma20", period_of_days=5)
print(df1)
